...
- Monitorar retenção e engajamento dos usuários ativos.  
- Avaliar eficiência dos investimentos em mídia e ROI.  
- Detectar padrões de churn nos finais de semana.  
- **Analisar abandono por idade e gênero**, revelando grupos mais vulneráveis e auxiliando na criação de campanhas segmentadas.
